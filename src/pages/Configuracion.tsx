    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-3 bg-white p-6 rounded-3xl border border-slate-200 shadow-premium">
        ...
        <div className="text-left">
          ...
          <p className="text-xs text-slate-400">Ajusta tus perfiles, selecciona plantillas de diseño y administra tu suscripción.</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSaveSettings} className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-left">
          <div className="lg:col-span-2 glass-card p-6 bg-white space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 p-5 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <div className="space-y-1.5 text-center sm:text-left">
                ...
                <p className="text-[10px] text-slate-400">Puedes subir imágenes de <b>cualquier tamaño</b> (incluso fotos pesadas de cámaras de 10MB o más). Se optimizarán y comprimirán localmente en tu navegador de forma instantánea.</p>
                {profilePic && (
                  <button
                    type="button"
            ...
            <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-4">
              <div>
                ...
                <p className="text-[10px] text-slate-400">Selecciona uno de los siguientes avatares diseñados para tu línea visual:</p>
              </div>
          ...
          <div className="glass-card p-6 bg-white space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-400">Escoge una de las plantillas con su paleta de colores e íconos representativos.</p>
              ...
              <div className="space-y-3.5">
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-[10px] text-slate-400 font-medium">Azul marino, esmeralda y lavanda.</p>
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-[10px] text-slate-400 font-medium">Frambuesa profundo, rosa y cian.</p>
                    <div className="flex gap-1 shrink-0">
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-[10px] text-slate-400 font-medium">Gris pizarra, azul cobalto y ámbar.</p>
                    <div className="flex gap-1 shrink-0">
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-[10px] text-slate-400 font-medium">Negro obsidiana, oro y esmeralda.</p>
                    <div className="flex gap-1 shrink-0">
        ...
        <div className="space-y-8 text-left">
          ...
          <div className="glass-card p-6 bg-white flex flex-col md:flex-row justify-between items-center gap-4 border border-slate-200">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Estado de Suscripción</p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-400">Escoge el plan idóneo para organizar tus próximos 6 meses.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className={`p-6 rounded-3xl border-2 bg-white flex flex-col justify-between space-y-6 ${
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-3xl font-black text-slate-800">$0 <span className="text-xs text-slate-400 font-normal">COP/mes</span></div>
                  <p className="text-[10px] text-slate-400">Acceso básico a bitácoras de hábitos y finanzas personales.</p>
              ...
              <div className={`p-6 rounded-3xl border-2 bg-white relative flex flex-col justify-between space-y-6 ${
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-3xl font-black text-slate-800">$29.900 <span className="text-xs text-slate-400 font-normal">COP/mes</span></div>
                  <p className="text-[10px] text-slate-400">Completo para llevar registro de tu vida personal y profesional.</p>
              ...
              <div className={`p-6 rounded-3xl border-2 bg-white flex flex-col justify-between space-y-6 ${
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-3xl font-black text-slate-800">$49.900 <span className="text-xs text-slate-400 font-normal">COP/mes</span></div>
                  <p className="text-[10px] text-slate-400">Soporte prioritize, multi-usuario y backups en la nube automatizados.</p>
